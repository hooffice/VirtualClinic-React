...
export interface LayoutState {
  ...
  leftSideBarThemeTypes: LEFT_SIDEBAR_THEME_TYPES.COLORED | LEFT_SIDEBAR_THEME_TYPES.DARK | LEFT_SIDEBAR_THEME_TYPES.LIGHT | LEFT_SIDEBAR_THEME_TYPES.GREATWHALE | LEFT_SIDEBAR_THEME_TYPES.LADYLIP | LEFT_SIDEBAR_THEME_TYPES.PLUMPLATE | LEFT_SIDEBAR_THEME_TYPES.WINTER | LEFT_SIDEBAR_THEME_TYPES.VC1 | LEFT_SIDEBAR_THEME_TYPES.VC2 | LEFT_SIDEBAR_THEME_TYPES.VC3
